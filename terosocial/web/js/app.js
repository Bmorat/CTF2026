...
(function () {
  ...
  function visitasDe(a) {
    if (a.id === 5116) return 34127;                   // pico bien alto
    var n = (a.id * 1103515245 + 12345) & 0x7fffffff;
    return 20 + (n % 381);                             // 20..400 el resto
  }
  ...
  function avisoHTML(a) {
    ...
    h += '<span class="aviso-vistas" style="display:block;font-size:12px;color:#6b7280;margin-top:2px">' + numero(visitasDe(a)) + ' vistas</span>';
    h += "</span></a>";
    return h;
  }
  ...
  vistas.aviso = function (cont) {
    ...
    h += '<li><span class="et">Vistas</span><span>' + numero(visitasDe(a)) + "</span></li>";
